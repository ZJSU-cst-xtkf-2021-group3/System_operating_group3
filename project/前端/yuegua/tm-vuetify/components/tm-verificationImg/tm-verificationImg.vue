	...
	<view class="tm-verificationImg flex-center flex-col">
		...
		>	
			...
			<view :style="{transform: `rotate(${default_value_num}deg)`}">
				<tm-images model="aspectFit" :width="size" :height="size" :round="24" :src="src"></tm-images>
			</view>
		</view>
		<view :style="{width:`${size}rpx`}" class="py-32">
			<tm-slider :fllowTheme="fllowTheme" :color="color_tmeme" v-model="default_value_num" :max="360"></tm-slider>
		</view>
	</view>
</template>
