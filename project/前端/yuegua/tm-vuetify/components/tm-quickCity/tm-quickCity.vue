<template>
	<view class="tm-quickCity fulled">
		...
		<view @click.stop="qiehuan" v-if="showbgOpen" class="tm-quickCity-fullbg fulled  absolute" :style="{height:sysHeight+'px'}">
			
			<view :style="{height:(height+180+content_jian_height)+'rpx'}"  @click.stop="" :class="[black_tmeme?'grey-darken-5 bk':'white']"  class=" tm-quickCity-wk absolute fulled round-t-10" >
