		...
		<tm-poup  @change="toogle" ref="pop" :black="false" v-model="showpop" height="auto" bg-color="none">
			...
			<view class="ma-32">
				...
				<view class=" round-4 overflow ">
					<tm-button :fllowTheme="false" :black="black_tmeme" iteme-class="mb-2" font-size="22" font-color="grey" :theme="black_tmeme?'grey-darken-4':'white'" block flat>{{title}}</tm-button>
					<slot>
						<tm-button
						 :fllowTheme="false"
						 :black="black_tmeme"
						 ...
						 :theme="black_tmeme?'grey-darken-4':'white'" block flat>{{item[rangKey]?item[rangKey]:item}}</tm-button>
					</slot>
				</view>
				<view style="height: 96upx " class="pb-24 pt-16">
					<tm-button :fllowTheme="false" :iteme-class="' text-weight-b'"  :black="black_tmeme" @click="close" round="4"  :theme="black?'grey-darken-4':'white'" block >取消</tm-button>
				</view>
			</view>
		</tm-poup>
	</view>
