	...
	<view class="tm-choujiang  py-32">
		<view class="tm-choujiang-theme-1 flex-center flex-col">
			<view class="tm-choujiang-bg ">
				...
				<view class="flex-center tm-choujiang-point"><tm-images @click="play" :previmage="false" :width="120" :src="them_data.point"></tm-images></view>
			</view>
			<view class="tm-choujiang-pingtai flex-center"><tm-images :previmage="false" :width="600" :src="them_data.dizuo"></tm-images></view>
		</view>
	</view>
</template>
