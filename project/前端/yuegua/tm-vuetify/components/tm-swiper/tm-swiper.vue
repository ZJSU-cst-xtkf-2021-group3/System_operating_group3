<template>
	<view class="tm-swiper " :class="[inline ? 'd-inline-block' : '']">
		...
		>
			<block v-for="(item, index) in dataList" :key="index">
				<swiper-item
					...
					class="shadow-24"
				>
					<view :class="[nowIndex !== index&&ani3d>0?'a3d':'',nowIndex<index&&ani3d>0?'a3dL':'',nowIndex>index&&ani3d>0?'a3dR':'']" class="tm-swiper-ik fulled fulled-height" :key="index">
		...
		<view class="tm-swiper-dot " v-if="indicatorDots" :class="[dotDirection]">
