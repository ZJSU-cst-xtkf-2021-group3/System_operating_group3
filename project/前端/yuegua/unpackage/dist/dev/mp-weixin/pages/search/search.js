...
var _search = _interopRequireDefault(__webpack_require__(/*! ./pages/search/search.vue */ 178));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}wx.__webpack_require_UNI_MP_PLUGIN__ = __webpack_require__;
...
try {
  components = {
    uSearch: function() {
      return Promise.all(/*! import() | uview-ui/components/u-search/u-search */[__webpack_require__.e("common/vendor"), __webpack_require__.e("uview-ui/components/u-search/u-search")]).then(__webpack_require__.bind(null, /*! @/uview-ui/components/u-search/u-search.vue */ 336))
    },
    uIcon: function() {
...
var render = function() {
  ...
  var l0 = _vm.__map(_vm.searchData, function(item, index) {
    ...
    var m0 = String(item.star)
    var m1 = String(item.Fcounts)
    var m2 = String(item.tip_off)
    var m3 = _vm.switchTime(item.lastUpDateTime)
    return {
      $orig: $orig,
      m0: m0,
      m1: m1,
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var TextCard = function TextCard() {__webpack_require__.e(/*! require.ensure | components/TextCard */ "components/TextCard").then((function () {return resolve(__webpack_require__(/*! @/components/TextCard */ 322));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var _default =
...

{
  ...
  methods: {
    ...
    tagclick: function tagclick(e) {var _this2 = this;
      var that = this;
      uni.request({
        url: 'http://101.37.175.115/HomePage/search',
        data: {
    ...
    onReachScollBottom: function onReachScollBottom() {
      var that = this;
      console.log("触底刷新");
  ...
  mounted: function mounted() {var _this3 = this;
    ...
    query.select('.searchbar').boundingClientRect(function (data) {
      _this3.headerheight = data.height;
    }).exec();

    uni.getSystemInfo({
      success: function success(e) {
        _this3.headerheight += e.windowTop + 6;
      } });
